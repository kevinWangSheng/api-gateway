...
public class ApplicationInterfaceMethodDataVO {
    ...
    public ApplicationInterfaceMethodDataVO(String systemId, String interfaceId, String methodId, String methodName, String parameterTypes, String uri, String httpCommandType, Integer auth) {
